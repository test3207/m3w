#!/bin/bash
# M3W Azure Budget Deployment Script
# Simplified script for single-environment deployment
...
LOCATION="eastasia"
APP_NAME="m3w-app"
BICEP_FILE="${SCRIPT_DIR}/main.budget.bicep"
PARAM_FILE="${SCRIPT_DIR}/parameters.budget.json"
...
show_help() {
    cat << EOF
${BLUE}M3W Azure Budget Deployment${NC}
